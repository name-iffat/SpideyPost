            ...
            <table class="tableContent" width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td width="5%">&nbsp;&nbsp;<a class="one" href="detail_admin.php?user=<?php echo $username; ?>">Detail</a></td>
                    </tr>
                <?php
                    if ($numrow == 0) {
                        echo '<tr>
            ...
            <table class="tableContent" width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo ucwords(strtolower($row['employeeAddress'])); ?></td>
                        <td>&nbsp;<?php echo $row['employeeContact']; ?></td>
                        <td width="5%">&nbsp;&nbsp;<a class="one" href="detail_employee.php?employeeID=<?php echo $row['employeeID']; ?>">Detail</a></td>
                    </tr>
                <?php
                    if ($numrow == 0) {
                        echo '<tr>
            ...
            <table class="tableContent" width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td width="5%">&nbsp;&nbsp;<a class="one" href="detail_user.php?custID=<?php echo $row['custID']; ?>">Detail</a></td>
                    </tr>
                <?php
                    if ($numrow == 0) {
                        echo '<tr>
