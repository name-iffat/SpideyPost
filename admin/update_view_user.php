...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            $query = "SELECT * FROM employee where level = 1 ORDER BY employeeName ";
            ...
            <table class="tableContent" width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td width="5%" align="center"><a class="one" href="update_admin.php?user=<?php echo $username; ?>">Edit</a></td>
                    </tr>
                <?php
                    if ($numrow == 0) {
                        echo '<tr>
            ...
            <?php
            //$username = $_SESSION['username'];
            $query = "SELECT * FROM employee where level =2 ORDER BY employeeName ";
            $result = mysqli_query($dbconn, $query) or die("Error: " . mysqli_error($dbconn));
            $numrow = mysqli_num_rows($result);
            ?>
            ...
            <table class="tableContent" width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo ucwords(strtolower($row['employeeAddress'])); ?></td>
                        <td>&nbsp;<?php echo $row['employeeContact']; ?></td>
                        <td width="5%" align="center"><a class="one" href="update_employee.php?employeeID=<?php echo $row['employeeID']; ?>">Edit</a></td>
                        <td width="5%" align="center"><a class="one" href="delete_employee.php?employeeID=<?php echo $row['employeeID']; ?>">Delete</a></td>
                    </tr>
                <?php
                    if ($numrow == 0) {
                        echo '<tr>
