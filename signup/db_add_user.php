...
if (isset($_POST['submit'])) {
    ...
    $sql0 = "SELECT username FROM customer WHERE username =  '$username'";
    ...
    if ($row0 != 0) {
        ...
        $sql2 = "INSERT INTO `customer` (`username`, `password`, `custName`, `gender`, `custAddress`, `custContact`, `custEmail`, `level_id`)
